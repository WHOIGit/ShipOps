  ...
  *nOfOutputs = 0;
  ...
  //----------------------------------------------------------------------------------
	...
	for(int promptNumber = 0; promptNumber < thisInputDescriptor.numberOfCsvParse; promptNumber++) {
	  ...
	  else if(0 == strcmp(scratchString, "TRANS_ARG1") ) { thisInputDescriptor.csvParse[promptNumber].parseDataType = CPD_TRANS_ARG1;}
	  else if(0 == strcmp(scratchString, "TRANS_ARG2") ) { thisInputDescriptor.csvParse[promptNumber].parseDataType = CPD_TRANS_ARG2;}
	  else if(0 == strcmp(scratchString, "TRANS_ARG3") ) { thisInputDescriptor.csvParse[promptNumber].parseDataType = CPD_TRANS_ARG3;}
	  else if(0 == strcmp(scratchString, "TRANS_ARG4") ) { thisInputDescriptor.csvParse[promptNumber].parseDataType = CPD_TRANS_ARG4;}
	  else if(0 == strcmp(scratchString, "TRANS_ARG5") ) { thisInputDescriptor.csvParse[promptNumber].parseDataType = CPD_TRANS_ARG5;}
