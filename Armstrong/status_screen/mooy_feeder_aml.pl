...
#                                   lstolp 201302ish
#
#  using to feed estimated Nitrate and phosphate to database for status screen
#                                   lstolp 20170430
...
# computer phosphate
$phosphate = 0.524 - (0.0187 * $aml_st);
$phosphate = sprintf("%.3f", $phosphate);


# stuff into the database for display and plotting
