...
#                  
#
#   20160903	   ams hacked knudsen for EM122
#
# 
#  version 20160903
#
...
#        sleep (.1);
        ...
        my $dep = shift @data;
          ...
          if ($dep =~ /\$KIDPT/)
           ...
           print "found \$KIDPT\n" if $debug;
           print "\@data = @data\n" if $debug;
           my @kidpt = qw /depthrel ducerdepth maxdepth+checksum EM122depth/;
	...
	my $totaldepth = $depth{depthrel}+$depth{ducerdepth};
	$depth{EM122depth} = $totaldepth;
