...
# changed refresh to 5 seconds
print header(-refresh=>'5'), start_html(-http_equiv=>"Pragma",
...
printf "&nbsp&nbsp&nbsp $white_font %02d:%02d:%02d UTC &nbsp&nbsp&nbsp", $time->hour, $time->min, $time->sec;
