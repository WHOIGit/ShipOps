...
print "Pragma: no-cache\n\n";
 print <<EOM;
<HTML>
<head> <title> Knorr HSN Plots </title> </head>

<frameset rows="*">
<frame src="http://www.atlantis.whoi.edu/cgi-bin/dygraphs/plot_csv.pl?checkbox=1&allchecked=1&radio=0&fileinfo=1&f=$tmp_dir/$out_file&width=1000&fill=1&max_recs=1000000&nrecs=10000000&title=$shipname&cols=3,4">
</frameset>
</HTML>
EOM
